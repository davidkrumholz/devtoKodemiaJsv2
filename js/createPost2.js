document.addEventListener("DOMContentLoaded", () => {
    ...
    publishBtn.addEventListener("click", async (event) => {
      ...
      //const postTags = Tagify.instance(document.querySelector('input[name=tags]')).value;
      let postBody = quill.root.innerHTML;
      ...
      let postRating = Math.random();
      let postRelevant = true; // Set relevant to true (you can change this based on your requirement)
